    ...
    <div className=' flex min-h-screen w-full'>
      ...
      <div className='lg:w-1/2 w-full flex items-center justify-center'>
        <div className='lg:w-[45%] lg:max-w-md w-full mx-4'>
          ...
          >
            <h1 className='font-semibold text-textcolor-primary text-center text-2xl mb-4 tracking-tighter font-poppins'>Login</h1>
            <input
              className='block w-full px-2 py-2 outline-none rounded-md mb-2 text-white bg-primary-light'
              type="text"
            ...
            />
            <input
              className='block w-full px-2 py-2 outline-none rounded-md mb-4 bg-primary-light text-white'
              type="text"
            ...
            <div className='text-xs flex gap-2 items-center'>
              <h6 className='text-textcolor-secondary'>Don't have an account?</h6>
              <Link to={"/signup"} className='text-accent font-semibold'>Signup</Link>
            </div>
          </form>
        </div>
      </div>
